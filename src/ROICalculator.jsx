...
export default function ROICalculator() {
  ...
  const minervaFee = annualCommission * 0.30;
      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-gray-300 max-w-2xl mx-auto">
            How does paying us 30% on closed deals compare to your current marketing, ad spend, and sales-support overhead?
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 bg-gray-800 rounded-2xl p-6 md:p-8">
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 w-full px-3 py-2 rounded-md bg-gray-900 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
              <p className="text-xs text-gray-500 mt-1">Developer commission you earn per sale — typically 3–5% in Phuket.</p>
            </div>
            <div>
          ...
          <div className="bg-gray-900 rounded-xl p-6 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <div>
                <div className="text-xs uppercase tracking-wider text-gray-500">Minerva fee (30% of closed-deal commission)</div>

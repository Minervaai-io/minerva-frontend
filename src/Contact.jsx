    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-3 gap-8">
        <form onSubmit={onSubmit} className="bg-white p-6 rounded-2xl border shadow-sm md:col-span-2">
          ...
          {/* NEW SECTION: Two buttons side-by-side */}
          <div className="mt-6 flex flex-wrap gap-4 items-center">
            <button
              type="submit"
              disabled={status === "loading"}
              className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-indigo-700 text-white font-semibold hover:bg-indigo-800 disabled:opacity-60"
            >
            ...
            <a
              href="https://calendly.com/cryptoaiking99/new-meeting"
              target="_blank"
